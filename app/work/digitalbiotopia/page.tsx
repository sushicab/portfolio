  ...
  return (
    <div>
      <PageInfo
        ...
        <br />
        <br />
        This tension inspired me to explore how  AI could enhance, rather than diminish, creativity. Using Midjourney, I envisioned an indoor world where nature and humanity peacefully coexist. 

I expanded this concept in Blender, adding imaginative elements—moss, tiny creatures, and other micro-level details—to a larger macro-scale environment. This attention to both the intimate and expansive aspects enriched the scene, bringing it to life.
        <br />
        <br />
        <br />
