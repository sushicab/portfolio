...
export default function About(){
    return (
      ...
      <h2 style={{marginTop: '50px',fontSize: "50px", textAlign: 'center', fontStyle: 'italic'}}>i dream, i dreamt</h2>
      <p style={{ textAlign: 'center', marginTop: '40px', marginBottom:"40px", fontStyle: 'italic' }}>
      ...
      <p style={{ margin: '20px', textAlign: 'justify', marginLeft:'200px', marginRight:'200px', marginBottom:'100px' }}>
        &quot;<i>Dreamt, I Dream</i>&quot; unfolds as an immersive interactive artistic creation of mine, inviting you into the realm of dream generation through the artificial brain 'no.01'. By responding to stimuli from the external world initiated by participants, this installation unveils the subjective interplay of memory and brain activities. The surreal experience of transforming disconnected and incongruent signals into a visually cohesive narrative is rekindled.
        <br /><br />
        ...
        <br /><br />
        We exist as components within the dreams of others, just as we perceive others' existence as integral elements in our own dreams.
      </p>
  ...
  <p style={{ marginBottom: '15px' }}>YIFAN ZHUANG  <strong>  Creative Direction & Interaction Design & CG Animation </strong> </p>
  <p style={{ marginBottom: '15px' }}>HUA MA  <strong>Technical Direction</strong></p>
  <p style={{ marginBottom: '15px' }}>ZIYUE WANG <strong>Engineer</strong></p>
  <p style={{ marginBottom: '15px' }}>SIYU MA  <strong>Theoretical Consulting</strong></p>
  <p style={{ marginBottom: '15px' }}>YINGTING HUANG  <strong>Sound Design</strong></p>
      </div>
      <div style={{ width: '50%',padding:"150px", marginRight:'100px' }}>
      <p style={{ marginBottom: '15px' }}>V I D E O  C R E D I T S</p>
    <p style={{ marginBottom: '15px' }}>YIFAN ZHUANG <strong> Direction & Shooting & Edit</strong></p>
    <p style={{ marginBottom: '15px' }}>YINGTING HUANG  <strong>Sound Design</strong></p>
    <p style={{ marginBottom: '15px', marginTop:'50px' }}>S P E C I A L  T H A N K S</p>
    ...
    <p style={{ marginBottom: '15px' }}>GRADUATE SCHOOL OF KEIO MEDIA DESIGN</p>
  </div>
      </div>
      </main>
    );
