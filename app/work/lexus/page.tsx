  ...
  return (
    <div>
      <PageInfo
        ...
        textContent={`At the <em>2025 Lexus Milan Design Week</ em>, I contributed as an <em>Interactive Visual Designer</ em> for a large-scale immersive installation that fused Japanese craftsmanship and advanced technology. The centerpiece was a 35km hand-woven bamboo screen that responded to the heartbeat of nearby visitors, embodying the Japanese concept of "A-Un no Kokyu"—a state of silent, synchronized harmony. </ br></ br> The installation went on to win <em>2nd place in the Audience Award</ em> and received the Design Schools Special Mention, standing out among over 1,000 exhibitors.`}
        imagePaths={[
          {
            type: "image",
